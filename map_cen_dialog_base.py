...
class Ui_MapCENDialogBase(object):
    def setupUi(self, MapCENDialogBase):
        ...
        self.tabWidget.setToolTipDuration(50)
        self.tabWidget.setStyleSheet("QWidget#tab{background-image: url(:/plugins/map_cen/background_plugin.PNG)}\n"
"QWidget#tab_2{background-image:url(:/plugins/map_cen/background_plugin.PNG)}\n"
"QWidget#tab_3{background-image: url(:/plugins/map_cen/background_plugin.PNG)}")
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.groupBox_2 = QtWidgets.QGroupBox(self.tab)
        self.groupBox_2.setGeometry(QtCore.QRect(50, 70, 331, 541))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 90, 211, 141))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 20, 171, 111))
        ...
        self.commandLinkButton_4.setGeometry(QtCore.QRect(50, 460, 221, 51))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/project.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.commandLinkButton_4.setIcon(icon)
        self.commandLinkButton_4.setIconSize(QtCore.QSize(30, 30))
        self.commandLinkButton_4.setObjectName("commandLinkButton_4")
        self.mComboBox = QgsCheckableComboBox(self.groupBox_2)
        self.mComboBox.setGeometry(QtCore.QRect(20, 320, 290, 20))
        self.mComboBox.setMinimumSize(QtCore.QSize(290, 20))
        self.mComboBox.setMaximumSize(QtCore.QSize(290, 20))
        self.mComboBox.setStyleSheet("")
        self.mComboBox.setMaxVisibleItems(15)
        self.mComboBox.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.mComboBox.setObjectName("mComboBox")
        self.label_12 = QtWidgets.QLabel(self.groupBox_2)
        self.label_12.setGeometry(QtCore.QRect(20, 250, 201, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_12.setFont(font)
        self.label_12.setStyleSheet("color: rgb(8, 8, 8);")
        self.label_12.setObjectName("label_12")
        self.label_15 = QtWidgets.QLabel(self.groupBox_2)
        self.label_15.setGeometry(QtCore.QRect(20, 300, 295, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_15.setFont(font)
        self.label_15.setStyleSheet("color: rgb(8, 8, 8);")
        self.label_15.setText("")
        self.label_15.setObjectName("label_15")
        self.mComboBox_3 = QgsCheckableComboBox(self.groupBox_2)
        self.mComboBox_3.setGeometry(QtCore.QRect(20, 360, 290, 20))
        self.mComboBox_3.setMinimumSize(QtCore.QSize(290, 20))
        self.mComboBox_3.setMaximumSize(QtCore.QSize(290, 20))
        self.mComboBox_3.setStyleSheet("")
        self.mComboBox_3.setMaxVisibleItems(15)
        self.mComboBox_3.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.mComboBox_3.setObjectName("mComboBox_3")
        self.comboBox_3 = QtWidgets.QComboBox(self.groupBox_2)
        self.comboBox_3.setGeometry(QtCore.QRect(20, 50, 191, 22))
        self.comboBox_3.setCurrentText("")
        self.comboBox_3.setObjectName("comboBox_3")
        self.comboBox_3.addItem("")
        self.pushButton = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton.setGeometry(QtCore.QRect(100, 410, 121, 23))
        self.pushButton.setObjectName("pushButton")
        self.checkBox = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox.setGeometry(QtCore.QRect(20, 300, 281, 17))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.mComboBox_4 = QgsCheckableComboBox(self.groupBox_2)
        self.mComboBox_4.setGeometry(QtCore.QRect(20, 270, 120, 20))
        self.mComboBox_4.setMinimumSize(QtCore.QSize(120, 20))
        self.mComboBox_4.setMaximumSize(QtCore.QSize(120, 20))
        self.mComboBox_4.setStyleSheet("")
        self.mComboBox_4.setCurrentText("")
        self.mComboBox_4.setMaxVisibleItems(15)
        self.mComboBox_4.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/jpg.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/logo.jpg"))
        ...
        self.label_9.setPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/zoom_out.png"))
        self.label_9.setScaledContents(True)
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.tab)
        self.label_10.setGeometry(QtCore.QRect(1080, 40, 21, 21))
        self.label_10.setText("")
        self.label_10.setPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/zoom.png"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/parametres.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.checkBox_2.setGeometry(QtCore.QRect(440, 40, 281, 17))
        font = QtGui.QFont()
        font.setPointSize(7)
        ...
        self.label_13.setPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/onglet.png"))
        self.label_13.setScaledContents(True)
        self.label_13.setObjectName("label_13")
        self.label_11 = QtWidgets.QLabel(self.tab_2)
        self.label_11.setGeometry(QtCore.QRect(310, 130, 531, 411))
        self.label_11.setText("")
        self.label_11.setPixmap(QtGui.QPixmap(":/plugins/map_cen/icons/underconstruction.gif"))
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(90, 210, 211, 21))
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(90, 300, 211, 21))
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(90, 390, 211, 21))
        self.lineEdit_4.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_4.setReadOnly(False)
        self.lineEdit_4.setClearButtonEnabled(True)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.mComboBox_2 = QgsCheckableComboBox(self.groupBox_7)
        self.mComboBox_2.setGeometry(QtCore.QRect(40, 480, 310, 20))
        self.mComboBox_2.setMinimumSize(QtCore.QSize(310, 20))
        ...
        self.mComboBox_2.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.mComboBox_2.setDefaultText("")
        self.mComboBox_2.setObjectName("mComboBox_2")
        self.label_14 = QtWidgets.QLabel(self.groupBox_7)
        self.label_14.setGeometry(QtCore.QRect(30, 440, 311, 41))
        font = QtGui.QFont()
        font.setBold(False)
        font.setUnderline(True)
        font.setWeight(50)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(40, 90, 261, 31))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(40, 120, 261, 31))
        ...
        self.mComboBox_4.setCurrentIndex(-1)
    ...
    def retranslateUi(self, MapCENDialogBase):
        ...
        self.radioButton_3.setToolTip(_translate("MapCENDialogBase", "Indisponible pour le moment !"))
        self.radioButton_3.setText(_translate("MapCENDialogBase", "Scan 25 IGN"))
        self.radioButton_4.setText(_translate("MapCENDialogBase", "Plan IGN"))
        ...
        self.mComboBox.setCurrentText(_translate("MapCENDialogBase", "Sélectionner le ou les site(s) ici"))
        self.mComboBox.setDefaultText(_translate("MapCENDialogBase", "Sélectionner le ou les site(s) ici"))
        self.label_12.setText(_translate("MapCENDialogBase", "Filtrer les sites par département :"))
        self.mComboBox_3.setDefaultText(_translate("MapCENDialogBase", "Périmètres écologiques :"))
        self.comboBox_3.setItemText(0, _translate("MapCENDialogBase", "Choix du type de carte :"))
        self.pushButton.setText(_translate("MapCENDialogBase", "Charger les couches"))
        self.checkBox.setText(_translate("MapCENDialogBase", "Afficher les codes sites plutôt que les noms"))
        ...
        self.checkBox_2.setText(_translate("MapCENDialogBase", "Exclure les autres sites à proximité"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MapCENDialogBase", "Liste de templates existants"))
